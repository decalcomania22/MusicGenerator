...
def preprocess(dataset_path):
  ...
  #filter out songs that have non-accceptable durations
...
def generating_training_sequences(sequence_length):
   #we are treating this as a time-series,supervised data
   ...
   inputs=utils.to_categorical(inputs,num_classes=vocabulary_size)
